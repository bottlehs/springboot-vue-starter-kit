...
public class QUser extends EntityPathBase<User> {
  ...
  public final com.bottlehs.springboot.backend.springboot_backend.api.module.common.base.entity.QBaseEntity _super =
      new com.bottlehs.springboot.backend.springboot_backend.api.module.common.base.entity.QBaseEntity(
          this);

  public final NumberPath<Integer> bookmark_card_cnt =
      createNumber("bookmark_card_cnt", Integer.class);
  ...
  public final NumberPath<Integer> create_humananswer_cnt =
      createNumber("create_humananswer_cnt", Integer.class);
  ...
  public final NumberPath<Integer> like_human_answer_cnt =
      createNumber("like_human_answer_cnt", Integer.class);

  public final NumberPath<Integer> like_receive_cnt =
      createNumber("like_receive_cnt", Integer.class);
  ...
  public final ListPath<String, StringPath> roles = this.<String, StringPath>createList("roles",
