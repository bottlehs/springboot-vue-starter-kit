...
public interface NoticeRepository extends JpaRepository<Notice, Integer> {
        ...
        @Query("select m from Notice m where " + "(?1 is null or upper(m.id) like concat('%', upper(?1), '%')) "
        ...
        Page<Notice> searchNotice(String id, String title, String cont, String tp, Date start_dt, Date end_dt,
