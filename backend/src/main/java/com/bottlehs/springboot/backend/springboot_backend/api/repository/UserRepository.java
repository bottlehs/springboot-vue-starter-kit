...
public interface UserRepository extends JpaRepository<User, Integer> {
        ...
        @Query("select m from User m where " + "(?1 is null or upper(m.id) like concat('%', upper(?1), '%')) "
        ...
        Page<User> searchUser(String id, String email, String first_name, String last_name, Date start_dt, Date end_dt,
