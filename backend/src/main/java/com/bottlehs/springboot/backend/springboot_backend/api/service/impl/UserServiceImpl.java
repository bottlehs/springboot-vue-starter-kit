...
public class UserServiceImpl implements UserService {
    ...
    // 수정
    @Override
    public User modify(Integer id, String email, String password, String first_name, String last_name) {
    ...
    // 조회-검색
    @Override
    public Page<User> searchUser(String id, String email, String first_name, String last_name, Date start_dt,
